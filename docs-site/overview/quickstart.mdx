...
<Steps>
  <Step title="Get your API key">
    Create an account and get an API key from your [monid.ai](https://bit.ly/monid-ai) dashboard. This is your own key, not ours. Every request authenticates with it in the `X-API-KEY` header, and every call bills your own Monid wallet. We never store or log it.
